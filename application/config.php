...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'gT"dsrA_<=nRExtqaQPi:4$7OM[FI2(`^Z0%L,#c', //默认数据加密KEY
	'data_cache_key'=> 'gT"dsrA_<=nRExtqaQPi:4$7OM[FI2(`^Z0%L,#c',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'gT"dsrA_<=nRExtqaQPi:4$7OM[FI2(`^Z0%L,#c', //加密KEY
