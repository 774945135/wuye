<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\www\twothink\public/../application/home/view/default/community\detail.html";i:1511944869;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <a href="javascript:;" class="btn btn-info"><h1>报名参加</h1></a>
...
<script type="text/javascript">
    $('.btn').click(function () {
        ...
        if(confirm('确定参加活动吗?')){
            ...
            var url = "<?php echo url('community/active'); ?>";
            var that = this;
            console.debug(url);
