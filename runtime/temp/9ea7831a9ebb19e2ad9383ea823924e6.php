<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\www\twothink\public/../application/home/view/default/my\index.html";i:1512039695;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-3">
                <img src="__PUBLIC__/home/image/5.png" width="60" height="60" />
            </div>
            <div class="col-xs-9">
                <?php echo get_username(); ?>
                <a href="<?php echo url('user/login/logout'); ?>">退出</a><br/>
                北大花园小区<br/>
        ...
        <div class="row text-center myLabel">
            ...
            <div class="col-xs-4 label-success"><a href="<?php echo url('repairs/detail?name='.get_username()); ?>"><span class="iconfont">&#xe609;</span>我的报修</a></div>
            <div class="col-xs-4 label-primary"><a href="<?php echo url('my/community?name='.get_username()); ?>"><span class="iconfont">&#xe606;</span>报名的活动</a></div>
        </div>
        <div class="blank"></div>
        <div>
