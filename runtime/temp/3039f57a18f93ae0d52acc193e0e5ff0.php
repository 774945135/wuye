<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\www\twothink\public/../application/home/view/default/community\index.html";i:1512061089;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <!--<div class="container-fluid">
        ...
        <div class="row noticeList">
            <a href="<?php echo url('community/detail?id='.$inform['id']); ?>">
                <div class="col-xs-2">
...
-->
    ...
    <script type="text/javascript">
        ...
        var getLists = function (page) {
            $(".get_more").remove();
            $.get("<?php echo url('community/ajaxlists'); ?>?page="+page,function (data) {
