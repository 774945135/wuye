<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\www\twothink\public/../application/admin/view/default/renting\edit.html";i:1512026052;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-title">
    <h2>
        <?php echo !empty($info['id'])?'编辑':'新增'; ?>租售
...
<form action="<?php echo url(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <input type="hidden" name="path" value="<?php echo (isset($info['path']) && ($info['path'] !== '')?$info['path']:''); ?>">
    ...
    <div class="form-item">
        <label class="item-label">租售标题</label>
        <div class="controls">
            <input type="text" class="text input-large" name="title" value="<?php echo (isset($info['title']) && ($info['title'] !== '')?$info['title']:''); ?>">
            <div>
                <label class="item-label">租售图片</label>
                <input type="file" name="path"><br>
                <?php
                if(!empty($info['path'])):
                    ?>
                <img src="__ROOT__\uploads\<?php echo $info['path']; ?>">
                <?php
                endif;
                ?>
            </div>

                    <label class="item-label">租售金额</label>
                    <div class="controls">
                        <input type="number" name="money" class="text input-large" value="<?php echo (isset($info['intro']) && ($info['intro'] !== '')?$info['intro']:''); ?>">
                    <label class="item-label">联系电话</label>
                    <div class="controls">
                        <input type="number" name="tel" class="text input-large" value="<?php echo (isset($info['intro']) && ($info['intro'] !== '')?$info['intro']:''); ?>">
                        <div class="form-item">
                    <label class="item-label">租售简介</label>
                    <div class="controls">
                        <input type="text" name="intro" class="text input-large" value="<?php echo (isset($info['intro']) && ($info['intro'] !== '')?$info['intro']:''); ?>">
                        <div class="form-item">

                    <label class="item-label">租售内容</label>
                    <div class="controls">
