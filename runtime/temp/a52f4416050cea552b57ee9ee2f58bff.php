<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\www\twothink\public/../application/home/view/default/article\ajaxlists.html";i:1512059398;}*/ ?>
    ...
    <div class="row noticeList">
        <a href="<?php echo url('inform/detail?id='.$inform['id']); ?>">
            <div class="col-xs-2">
                <img style="width: 100px;height: 100px;" class="noticeImg" src="<?php echo $inform['path']; ?>" />
            </div>
            <div class="col-xs-10">
