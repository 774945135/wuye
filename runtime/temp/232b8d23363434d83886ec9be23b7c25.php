<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\www\twothink\public/../application/admin/view/default/shop\index.html";i:1511935235;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tr>
            ...
            <td><?php echo $shop['content']; ?></td>
            <td><?php echo $shop['admin']; ?></td>
            <td><?=date('Y-m-d h:i:s',$shop['create_time']);?></td>
            <td><?php echo $shop['click']; ?></td>
            <td><?=$shop['status']==1?'发布':'未发布'?></td>
            <td>
                <a title="编辑" href="<?php echo url('edit?id='.$shop['id'].'&pid='.$pid); ?>">编辑</a>
                <a title="状态" href="<?php echo url('status?id='.$shop['id'].'&pid='.$pid); ?>"><?=$shop['status']==1?'未发布':'发布'?></a>
                <a class="confirm ajax-get" title="删除" href="<?php echo url('del?id='.$shop['id']); ?>">删除</a>
            </td>
        </tr>
