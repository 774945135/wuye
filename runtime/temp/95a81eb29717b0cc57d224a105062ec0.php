<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\www\twothink\public/../application/admin/view/default/about\index.html";i:1512035482;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <label class="item-label">关于我们</label>
                        <div class="controls">
                            <textarea name="content" class="textarea input-large"  cols="30" rows="10"><?php echo (isset($result['content']) && ($result['content'] !== '')?$result['content']:''); ?></textarea>
                            <div class="form-item">
                                <br>
