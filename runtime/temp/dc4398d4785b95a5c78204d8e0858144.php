<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\www\twothink\public/../application/home/view/default/renting\index.html";i:1512026424;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
        ...
        <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
            ...
            <div id="myTabContent" class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                    ...
                    <div class="row">
                        <?php if(is_array($rent) || $rent instanceof \think\Collection || $rent instanceof \think\Paginator): $i = 0; $__LIST__ = $rent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                        <div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                <img src="__ROOT__\uploads\<?php echo $v['path']; ?>" alt="...">
                                <div class="caption">
                                    <h4><?php echo $v['title']; ?></h4>
                                    <p class="zushouInfo"><?php echo $v['intro']; ?></p>
                                    <p class="text-danger"><?php echo $v['money']; ?>元/月</p>
                ...
                <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                    <div class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                        ...
                        <div class="row">
                            <?php if(is_array($sell) || $sell instanceof \think\Collection || $sell instanceof \think\Paginator): $i = 0; $__LIST__ = $sell;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <div class="col-xs-6 col-md-4">
                                <div class="thumbnail">
                                    <img src="__ROOT__\uploads\<?php echo $v['path']; ?>" alt="...">
                                    <div class="caption">
