<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\www\twothink\public/../application/home/view/default/shop\index.html";i:1512061103;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <script type="text/javascript">
        ...
        var getLists = function (page) {
            $(".get_more").remove();
            $.get("<?php echo url('shop/ajaxlists'); ?>?page="+page,function (data) {
