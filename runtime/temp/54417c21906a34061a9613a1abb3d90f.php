<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\www\twothink\public/../application/admin/view/default/community\edit.html";i:1511936292;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-title">
    <h2>
        <?php echo !empty($info['id'])?'编辑':'新增'; ?>小区活动
...
<form action="<?php echo url(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <div class="form-item">
        ...
        <div class="controls">
            ...
            <label class="item-label">小区活动有效期</label>
            <div class="controls">
                ...
                <div class="form-item">
                    ...
                    <label class="item-label">小区活动内容</label>
                    <div class="controls">
